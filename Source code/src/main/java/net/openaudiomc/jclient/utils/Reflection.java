...
public class Reflection {
    ...
    public Reflection(OpenAudioMc main) {
    ...
    public void sendChatPacket(Player p, String json) {
        if (isReflectionSupported()) {
            try {
                ...
                OpenAudioMc.getInstance().getLogger().warning("Oh no! Something went wrong. Please open an issue at https://github.com/Mindgamesnl/OpenAudioMc with this information:");
                OpenAudioMc.getInstance().getLogger().warning("Reflection crash report for " + OpenAudioMc.getInstance().getServer().getName() + " version " + OpenAudioMc.getInstance().getServer().getVersion() + " (" +
                        OpenAudioMc.getInstance().getServer().getBukkitVersion() + ") with reflection version " + version);
                OpenAudioMc.getInstance().getLogger().warning("Reflection cause: " + exception.getMessage());
                OpenAudioMc.getInstance().getLogger().warning("Reflection stack trace: ");
